        ...
        <div class="blog-post single-post">
          ...
          <div class="comments">
            ...
            <ul class="comments-list">
              ...
              <li>
                <img src="/public/img/author-thumbs/2.jpg" alt="">
                <div class="comment-text">
      ...
      <div class="col-lg-4 sidebar">
        ...
        <div class="sb-widget">
          ...
          <div class="latest-news-widget">
            <div class="ln-item">
              <img src="/public/img/blog-thumbs/1.jpg" alt="">
              <div class="ln-text">
            ...
            <div class="ln-item">
              <img src="/public/img/blog-thumbs/2.jpg" alt="">
              <div class="ln-text">
                <div class="ln-date">April 1, 2019</div>
                <h6>10 Amazing new games</h6>
                <div class="ln-metas">
            ...
            <div class="ln-item">
              <img src="/public/img/blog-thumbs/3.jpg" alt="">
              <div class="ln-text">
                <div class="ln-date">April 1, 2019</div>
                <h6>10 Amazing new games</h6>
                <div class="ln-metas">
            ...
            <div class="ln-item">
              <img src="/public/img/blog-thumbs/4.jpg" alt="">
              <div class="ln-text">
                <div class="ln-date">April 1, 2019</div>
                <h6>10 Amazing new games</h6>
                <div class="ln-metas">
        ...
        <div class="sb-widget">
          <a href="#" class="add">
            <img src="/public/img/add-2.jpg" alt="">
          </a>
        </div>
        <div class="sb-widget">
          ...
          <div class="latest-comments-widget">
            ...
            <div class="lc-item">
              <img src="/public/img/author-thumbs/3.jpg" alt="">
              <div class="lc-text">
                <h6>Jane Smith<span> In </span><a href="">The best 2019 Games</a></h6>
                <div class="lc-date">April 1,2019</div>
              </div>
            ...
            <div class="lc-item">
              <img src="/public/img/author-thumbs/4.jpg" alt="">
              <div class="lc-text">
                <h6>Michael James<span> In </span><a href="">The best 2019 Games</a></h6>
                <div class="lc-date">April 1,2019</div>
              </div>
