<section class="water-form js-popup">
  <div class="water-form__wrapper">
    ...
    <label class="water-form__box">
      <?= $form->field($waterForm, 'hotwater')->textInput(['class'=>'water-form__input water-form__input--number','data-field-type'=> 'number'])->label(false);?>
      <span class="water-form__label">Горячая вода</span>
    </label>
    <label class="water-form__box">
      <?= $form->field($waterForm, 'coldwater')->textInput(['class'=>'water-form__input water-form__input--number','data-field-type'=> 'number'])->label(false);?>
      <span class="water-form__label">Холодная вода</span>
    </label>
    <label class="water-form__box">
      <?= $form->field($waterForm, 'apartment')->textInput(['class'=>'water-form__input water-form__input--number','data-field-type'=> 'number'])->label(false);?>
